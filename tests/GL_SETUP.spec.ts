...
// Por lo que se usa la siguiente forma para hacer click directamente en el desplegable

  //await page.getByRole('listbox').filter({ hasText: 'Day' }).getByLabel('select').locator('span').click();
  //await page.getByRole('option', { name: 'dd (01)' }).click(); // Seleccion del formato que se quiera
//
  //await page.getByRole('listbox').filter({ hasText: 'Year' }).getByLabel('select').locator('span').click();
  //await page.getByRole('option', { name: 'yy (25)' }).click(); // Seleccion del formato que se quiera
//
//
  //await page.getByRole('listbox').filter({ hasText: 'Month' }).getByLabel('select').locator('span').click();
  //await page.getByRole('option', { name: 'M (9)' }).click(); // Seleccion del formato que se quiera
...
// Añadir Custom Column
  ...
  // Nopmbre de la selccion que queramos
  //await page.getByRole('option', { name: 'Colums (3)' }).click();
  //// Rellenamos las otras selecciones en base de lo elegido anteriormente
  //await page.getByRole('group', { name: 'Add Custom Column' }).getByLabel('select').nth(1).click();
  //await page.getByRole('option', { name: 'CurrentDate' }).click();
  //await page.getByRole('group', { name: 'Add Custom Column' }).getByLabel('select').nth(2).click();
  //await page.getByRole('option', { name: 'Debit Description' }).click();
  //await page.getByRole('group', { name: 'Add Custom Column' }).getByLabel('select').nth(3).click();
  //await page.getByRole('option', { name: 'Credit Description' }).click();
  //await page.locator('#addCustomColumnButton').click(); // Añadir la columna personalizada
...
// Chart of Account
  ...
  //await page.getByRole('link', { name: ' Añadir Nuevo' }).click();
//
  //await page.getByRole('row', { name: 'Select row 0 ' }).getByLabel('select', { exact: true }).locator('span').click();
  //await page.getByRole('option', { name: 'Academics Affairs' }).click();
  //await page.locator('.k-grid-edit-row > td:nth-child(3)').click();
//
  //await page.getByRole('row', { name: 'Select row   Academics' }).getByLabel('select', { exact: true }).locator('span').click();
  //await page.getByRole('option', { name: 'Academic Support Officer' }).click();
  //await page.locator('.k-grid-edit-row > td:nth-child(7)').click();
//
  //await page.getByRole('row', { name: 'Select row   Academics' }).getByLabel('select', { exact: true }).locator('span').click();
  //await page.getByRole('option', { name: 'HOLA' }).click();
...
// Preview y generacion del reporte
  ...
  await page.getByRole('option', { name: '/ Bi-Weekly / 25941' }).click();
